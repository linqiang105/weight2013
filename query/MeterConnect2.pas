...
begin
  ...
  try
    ...
    myini.WriteInteger('meter2', 'remotePort', StrToIntDef(LEPort.Text, 8889));
...
begin
  ...
  try
    ...
    PollingDelay.Value := myini.ReadInteger('meter2', 'polling', 500);
    ...
    LEPort.Text := myini.ReadString('meter2', 'remotePort', '8889');
  ...
  begin
    //IdUDPS.IP := '0.0.0.0';
    IdUDPS.DefaultPort := StrToIntDef(LEPort.Text, 8889);
  ...
  begin
    ...
    IdUDPC.Port := StrToIntDef(LEPort.Text, 8889);
    IDUDPC.Active := True;
...
begin
  ...
  try
    ...
    if MainForm.systemConfig.cheatType then
      MainForm.FrmWeight1.PWeight2.Caption := FormatFloat(MainForm.systemConfig.meterShowMode,
...
function TMeterConnect2Form.YBPersonlize(s: string): string;
