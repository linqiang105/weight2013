...
begin
  CBCar.Caption := MainForm.weightSetConfig.carCaption;
  CBFaHuo.Caption := MainForm.weightSetConfig.faHuoCaption;
  CBShouHuo.Caption := MainForm.weightSetConfig.shouHuoCaption;
  CBGoods.Caption := MainForm.weightSetConfig.goodsCaption;
  CBSpec.Caption := MainForm.weightSetConfig.specCaption;
  CBBackup1.Caption := MainForm.weightSetConfig.backup1Caption;
  CBBackup2.Caption := MainForm.weightSetConfig.backup2Caption;
  CBBackup3.Caption := MainForm.weightSetConfig.backup3Caption;
  CBBackup4.Caption := MainForm.weightSetConfig.backup4Caption;
  CBBackup5.Caption := MainForm.weightSetConfig.backup5Caption;
  CBBackup10.Caption := MainForm.weightSetConfig.backup10Caption;
  CBBackup11.Caption := MainForm.weightSetConfig.backup11Caption;
  CBBackup12.Caption := MainForm.weightSetConfig.backup12Caption;
  CBBackup13.Caption := MainForm.weightSetConfig.backup13Caption;
  CBBackup14.Caption := MainForm.weightSetConfig.backup14Caption;
end;
