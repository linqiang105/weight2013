...
begin
  ...
  begin
    Close;
    SQL.Text := 'select ' + s + ' from ' + s + ' where 代码=:code';
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,备用1 as [' + MainForm.weightSetConfig.backup1Caption +
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,备用10 as [' + MainForm.weightSetConfig.backup10Caption
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,备用11 as [' + MainForm.weightSetConfig.backup11Caption
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,备用12 as [' + MainForm.weightSetConfig.backup12Caption
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,备用13 as [' + MainForm.weightSetConfig.backup13Caption
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,备用14 as [' + MainForm.weightSetConfig.backup14Caption
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,备用2 as [' + MainForm.weightSetConfig.backup2Caption
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,备用3 as [' + MainForm.weightSetConfig.backup3Caption
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,备用4 as [' + MainForm.weightSetConfig.backup4Caption
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,备用5 as [' + MainForm.weightSetConfig.backup5Caption
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 车号 as [' + MainForm.weightSetConfig.carCaption
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,发货单位 as [' + MainForm.weightSetConfig.faHuoCaption
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,货名 as [' + MainForm.weightSetConfig.goodsCaption
      + '],单价 as [' + MainForm.weightSetConfig.priceCaption + '],折方系数 as ['
      + MainForm.weightSetConfig.scaleCaption + '] from 货名 where 货名 like :search';
    Parameters.ParamByName('search').Value := '%' + search + '%';
    Open;
  end;
end;
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,收货单位 as [' + MainForm.weightSetConfig.shouHuoCaption
...
begin
  ...
  begin
    Close;
    SQL.Text := 'select 代码,规格 as [' + MainForm.weightSetConfig.specCaption
