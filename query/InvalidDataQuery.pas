...
procedure TInvalidDataQueryForm.loadDBGrid;
var i: Integer;
  fn: string;
begin
  ...
  begin
    ...
    DBGridEhExceed.FieldColumns[fn].Title.Caption := MainForm.DBGridEh1.FieldColumns[fn].Title.Caption;
    DBGridEhExceed.FieldColumns[fn].Visible := MainForm.DBGridEh1.FieldColumns[fn].Visible;
  end;
  for i := 0 to DBGridEhExceed.Columns.Count - 1 do
  begin
    DBGridEhExceed.Columns[i].Width := MainForm.DBGridEh1.Columns[i].Width;
  end;
end;
...
var SelNo: string;
begin
  SelNo := DBGridEhExceed.DataSource.DataSet.FieldByName('流水号').AsString;
  if SelNo <> '' then
