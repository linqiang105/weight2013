...
begin
  ...
  DBGridEhTao.FieldColumns['车号'].Title.Caption := MainForm.weightSetConfig.carCaption;
  DBGridEhTao.FieldColumns['发货单位'].Title.Caption := MainForm.weightSetConfig.faHuoCaption;
  DBGridEhTao.FieldColumns['收货单位'].Title.Caption := MainForm.weightSetConfig.shouHuoCaption;
  DBGridEhTao.FieldColumns['货名'].Title.Caption := MainForm.weightSetConfig.goodsCaption;
  DBGridEhTao.FieldColumns['规格'].Title.Caption := MainForm.weightSetConfig.specCaption;
  DBGridEhTao.FieldColumns['备用1'].Title.Caption := MainForm.weightSetConfig.backup1Caption;
  DBGridEhTao.FieldColumns['备用2'].Title.Caption := MainForm.weightSetConfig.backup2Caption;
  DBGridEhTao.FieldColumns['备用3'].Title.Caption := MainForm.weightSetConfig.backup3Caption;
  DBGridEhTao.FieldColumns['备用4'].Title.Caption := MainForm.weightSetConfig.backup4Caption;
  DBGridEhTao.FieldColumns['备用5'].Title.Caption := MainForm.weightSetConfig.backup5Caption;
  DBGridEhTao.FieldColumns['备用10'].Title.Caption := MainForm.weightSetConfig.backup10Caption;
  DBGridEhTao.FieldColumns['备用11'].Title.Caption := MainForm.weightSetConfig.backup11Caption;
  DBGridEhTao.FieldColumns['备用12'].Title.Caption := MainForm.weightSetConfig.backup12Caption;
  DBGridEhTao.FieldColumns['备用13'].Title.Caption := MainForm.weightSetConfig.backup13Caption;
  DBGridEhTao.FieldColumns['备用14'].Title.Caption := MainForm.weightSetConfig.backup14Caption;
