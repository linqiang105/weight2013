object PhotoForm: TPhotoForm
  ...
  object MainPanel: TPanel
    ...
    object BtnImportTare: TRzBitBtn
      Left = 756
      Top = 368
      Width = 23
      Height = 22
    ...
    object BtnImportGross: TRzBitBtn
      Left = 756
      Top = 56
      Width = 23
      Height = 22
    ...
    object PGrossImage1: TPanel
      ...
      object GrossImage1: TImage
        ...
        Align = alClient
        Stretch = True
        OnClick = GrossImage1Click
        OnContextPopup = GrossImage1ContextPopup
      end
    end
